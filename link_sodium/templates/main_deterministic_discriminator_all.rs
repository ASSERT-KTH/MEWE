...
fn main(mut req: Request<Body>) -> Result<impl ResponseExt, Error> {
    ...
    main_bin2base64();
    main_sodium_increment();
    main_sodium_memcmp();
    main_sodium_is_zero();
    main_sodium_add();
    main_crypto_core_ed25519_scalar_random();
    main_crypto_core_ed25519_scalar_complement();
    main_crypto_core_ed25519_scalar_invert();
    main_crypto_aead_chacha20poly1305_ietf_decrypt_detached();
