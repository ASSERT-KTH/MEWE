CURRENT="$PWD"
OUT_FOLDER="multivariant2"
ORIGINAL_BITCODE=$1
MEWE_FOLDER=$2
VARIANTS_FOLDER=$3
shift 3

args="--variants-no-inline --instrument-only-variants --instrument-include=generate_fractal,lipv_image,fliph_image,blur_image,crop_image,grayscale_image,invert_image,rotate90_image,unsharpen_image"
