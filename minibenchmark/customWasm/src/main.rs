...
fn main(mut req: Request<Body>) -> Result<impl ResponseExt, Error> {
    ...
    match (req.method(), req.uri().path()) {
        ...
        (&Method::GET, "/sleep300u") => {

            let now = std::time::Instant::now();
            let duration = std::time::Duration::from_micros(300);
        ...
        (&Method::GET, "/sleep875u") => {

            let now = std::time::Instant::now();
            let duration = std::time::Duration::from_micros(875);
